...
SELECT filmes.Id, Nome, genero FROM Filmes INNER JOIN FilmesGenero on Filmes.Id = FilmesGenero.Id Inner join Generos ON FilmesGenero.Id = Generos.Id

SELECT Nome, genero FROM Filmes INNER JOIN FilmesGenero on Filmes.Id = FilmesGenero.Id Inner join Generos ON FilmesGenero.Id = Generos.Id WHERE Genero = 'mistério'

SELECT Nome, PrimeiroNome, UltimoNome, Papel FROM Filmes JOIN ElencoFilme ON Filmes.Id = ElencoFilme.Id JOIN Atores ON ElencoFilme.Id = Atores.Id
